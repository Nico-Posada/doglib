"""
Tests for DWARFCrafter and DWARFArrayCrafter (_crafter.py).

Covers: craft/parse/cast, operators (arithmetic/bitwise/comparison/format),
memory model (unions, shared backing), container API (items, values, fill,
cyclic, copy, index, count), OOB writes, slice assignment, indexing,
string-key escape hatch, and numeric truncation.

Run from the project root:
    pytest tests/orc/test_crafter.py
"""
import math
import struct
...
from doglib.orc import ORCInline, DWARFArrayCrafter, C64
